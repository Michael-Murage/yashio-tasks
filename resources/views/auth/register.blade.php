            ...
            <div class='w-full sm:max-w-md px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg my-auto my-auto'>
                <form method="POST" id="registration-form" action="{{ route('register-user') }}" class=''>
                    ...
                    <div>
                        ...
                        <input type="text" name='name' class='border-gray-300 focus:border-indigo-500 rounded-md shadow-sm block mt-1 w-full'>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="password" name='password-confirm' class='border-gray-300 focus:border-indigo-500 rounded-md shadow-sm block mt-1 w-full'>
                    </div>
